...
class SmileAlert: UIView {
    /// 根据RGBA生成颜色(格式为：22,22,22,0.5)
        ...
        func createAlertView() {
            ...
            //spring动画白底(弹出主体)
            bgView.frame = CGRect(x: 30, y: Screen_height/2 - 100, width: Screen_width - 60, height: 200)//设置大小及其位置
            ...
            sureBtn.backgroundColor = UIColor.init(red: 27/255, green: 39/255, blue: 85/255, alpha: 1)
